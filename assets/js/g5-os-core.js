...
const G5OS = {
    ...
    previewAsset(type, name) {
        ...
        if (type.includes('image') || name.endsWith('.jpg') || name.endsWith('.png')) {
            // Use a placeholder image service or a gradient box
            viewHtml = `
            ...
            viewHtml = `
                <div class="preview-code-mock" style="height:400px;background:#111;padding:20px;font-family:'JetBrains Mono', monospace;color:#a5d6ff;overflow-y:auto;">
                    <div style="color:#8b949e;">/* ${name} - Generated by CC-01 */</div>
                    <br>
                    <div><span style="color:#ff7b72;"># CAMPAIGN HEADLINES</span></div>
                    <br>
                    <div>1. "Don't hire an agency. License a civilization."</div>
                    <div>2. "Your new marketing team runs on silicon. And it never sleeps."</div>
                    <div>3. "Agenticum G5: The last growth hack you will ever need."</div>
                    <br>
                    <div><span style="color:#ff7b72;"># SOCIAL COPY (Twitter/X)</span></div>
                    <br>
                    <div>The old way: Briefing -> Waiting 2 weeks -> Revisions.</div>
                    <div>The G5 way: Intent -> 5 mins -> Execution. 🚀</div>
                    <div>#AI #Marketing #Automation</div>
                </div>`;
        }
        else {
